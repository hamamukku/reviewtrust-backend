...
public class AdminProductsController {
    ...
    public ResponseEntity<?> toggleVisibility(
            ...
            @RequestBody(required = false) ToggleVisibilityRequest request
    ) {
        if (request == null) {
            return error(HttpStatus.BAD_REQUEST, "E_BAD_REQUEST", "'visible' field is required", "missing_visible");
        }
        try {
            ToggleVisibilityResult result = productService.toggleVisibility(productId, request.visible());
            audit.write("PRODUCT_TOGGLE_VISIBILITY", Map.of(
            ...
            return error(HttpStatus.INTERNAL_SERVER_ERROR, "E_INTERNAL", "Failed to toggle visibility", e.getClass().getSimpleName());
        }
    }
    ...
    public record ToggleVisibilityRequest(boolean visible) { }
    ...
    public interface ProductService {
        ...
        ToggleVisibilityResult toggleVisibility(String productId, boolean visible);
    }
    ...
    public record ToggleVisibilityResult(String productId, boolean visible) {}
}
