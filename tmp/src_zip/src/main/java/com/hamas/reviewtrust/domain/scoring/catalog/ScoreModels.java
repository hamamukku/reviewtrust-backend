...
public final class ScoreModels {
    ...
    /** サクラ判定 */
    public enum SakuraJudge { SAFE, LIKELY_SAKURA, SAKURA }
    ...
    public static final class ScoreResult {
        ...
        public static ScoreResult error(String productId, String code, String message){
            return new ScoreResult(productId, null, null, null, Map.of(), List.of(), List.of(),
                    Instant.now().toString(), Map.of("code", code, "message", message));
        }
